...
function createComplexBody(){
    ...
    // Crear el seguno accesorio y añadir una forma poligonal al cuerpo
    fixtureDef.shape = new b2PolygonShape;
    var points = [
        new b2Vec2(0,0),
...
function createRevoluteJoint(){
    ...
    // Crear el segundo accesorio y añadir un polñigono al cuerpo
    ...
    // Crear una articulaciñon entre el body1 y el body2
...
function createFloor(){
    ...
    fixtureDef2.density = 1.0;
    fixtureDef2.friction = 0.5;
    fixtureDef2.restitution = 0.3;   //Rebote
    fixtureDef2.shape = new b2PolygonShape;
    var points = [
...
function drawSpecialBody() {
    ...
    // Transladar y girar el eje a la posición y al ángulo del cuerpo
