...
(function() {
    /* El método window.requestAnimationFrame informa al navegador que quieres realizar una 
    animación y solicita que el navegador programe el repintado de la ventana para el 
    próximo ciclo de animación. El método acepta como argumento una función a la que llamar
    ...
    /* window.cancelAnimationFrame Cancela la petición de animación previamente 
    programada a través de window.requestAnimationFrame(). */
...
var game = {
        // Empieza inicializando objetos, precargando assets (elementos) y muestra la pantalla de inicio
        init: function(){
            ...
            //Conseguir el handler para el canvas del juego y el contexto
        ...
        start :function(){
            ...
            game.mode = "intro"; // Almacena el estado actual del juego
            game.offsetLeft = 0;
            game.ended = false;
        ...
        handlePanning:function(){
            ...
            if (game.mode == "fired"){	/*	
                ...
                //Y esperar hasta que deje de moverse o esté fuera de los límites
            ...
            if(game.mode =='load-next-hero'){
                ...
                // Comprueba si hay villanos está vivo, si no, termina el nivel (éxito)
                ...
                if(!game.currentHero){
                    ...
                    // Espera a que el héroe deje de rebotar y se duerma y luego cambie a espera para disparar (wait-for-firing)
                    game.panTo(game.slingshotX);
    ...
    drawSlingshotBand:function(){
        ...
        game.context.lineWidth = 6; // Dibuja una lÃínea gruesa
        ...
        // Iniciar la lÃínea desde la parte superior de la honda (la parte trasera)
        game.context.moveTo(game.slingshotX+50-game.offsetLeft, game.slingshotY+25);	

        // Dibuja lí­nea al centro del héroe
...
var levels = {
    ...
    data:[
        ...
        init:function(){
            ...
            // Obtener o asignar código html en el DOM
            $('#levelselectscreen').html(html);

            // Establece los controladores de eventos de clic de botoón para cargar el nivel
        ...
        load:function(number){
            ...
            // Cargar las entidades del nivel
            ...
            if(loader.loaded){
                game.start(); // Es donde el juego actual será dibujado
            }
            else{
                // Cuando el loader esté cargado, se ejecuta el juego --> game.start()
        ...
        create : function(entity){
            ...
            switch (entity.type){
                ...
                case "hero" : // Círculos simples
                    ...
                    break;*/
                case "villain": // Pueden ser círulos o rectángulos
                    entity.health = definition.fullHealth;
                    entity.fullHealth = definition.fullHealth;
                    entity.sprite = loader.loadImage("images/entities/"+entity.name+".png");
    ...
    var box2d= {
        ...
        init: function(){
            ...
            var allowSleep = true;// Permite que los objetos que están en reposo se queden dormidos y se excluyan de los cáluclos
    ...
    var loader={
        ...
        itemLoaded:function(){
            ...
            if(loader.loadedCount == loader.totalCount){
                ...
                $('#loadingscreen').hide();
                // Llama al método loader.onload si este existe
                if(loader.onload){
                    loader.onload();
    ...
    var mouse = {
        ...
        y:0,
        down:false,
        // Fija los eventos para cuando se mueve, se presiona o se libera el botón del ratón
        init:function(){
        ...
        mousedownhandler:function(ev){
            ...
            // Cancelamos la acción causada por el evento predeterminado
